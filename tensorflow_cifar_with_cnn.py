...
CIFAR_DIR =  r'C:\Users\HP\Desktop\New folder\Tensorflow-Bootcamp-master\03-Convolutional-Neural-Networks\cifar-10-batches-py/'
...
batch_meta
"""
Why the 'b's in front of the string? Bytes literals are always prefixed with 
'b' or 'B'; they produce an instance of the bytes type instead of the str type. They may only contain ASCII characters; bytes with a numeric value of 128 or greater must be expressed with escapes.
...
"""  Create a new full layer using the normal_full_layer function and
 passing in your flattend convolutional 2 layer with size=1024. 
 (You could also choose to reduce this to something like 512)
 
 """
full_layer_one = tf.nn.relu(normal_full_layer(convo_2_flat,1024))

"""
Now create the dropout layer with tf.nn.dropout, remember 
to pass in your hold_prob placeholder. 
...
ross_entropy = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels=y_true,logits=y_pred))
